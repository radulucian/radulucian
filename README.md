...
**Cloud & DevOps** -- Designing resilient infrastructure on AWS with CI/CD pipelines, Infrastructure as Code, and containerized deployments.

**Full-Stack Web Development** -- Building responsive platforms with modern frameworks, CMS integrations, and end-to-end deployment workflows.

**Mobile Development** -- Building mobile applications with Java and Flutter.

**Photography** -- Visual storytelling through landscape, urban, and street photography. Featured on 500px.
...
![CloudFormation](https://img.shields.io/badge/CloudFormation-E7157B?style=flat&logo=amazonwebservices&logoColor=white)
...
**Featured Photographer** -- 500px Community
